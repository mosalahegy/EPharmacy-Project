...
<nav class="navbar nav-header">
  <div class="container header-info">
    <!-- Brand and toggle get grouped for better mobile display -->
      ...
      <i class="fa fa-phone"> 01156970386 / 01001109289</i>
      <i class="fa fa-envelope"> <a style='color:#777777;' href="https://www.google.com/smohamedh">SMohamedH@gmail.com</a></i>
       ...
       <div class="pull-right">
          <?php
            ...
            {
          ?>
              <a href="admin/index.php"><?php echo $admin->data()['FullName']?></a>
          <?php
            }
            else
            {
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        ?>
        <li class="<?php if('index' == $word) echo 'active'?>"><a href="index.php">Home</a></li>
